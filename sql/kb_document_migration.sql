...
-- 2. 给 kb_document 表添加 folder_id 字段
ALTER TABLE `kb_document`
    ADD COLUMN `folder_id` bigint NOT NULL DEFAULT '0' COMMENT '所属文件夹ID: 0=根目录' AFTER `kb_id`;

-- 3. 添加索引
ALTER TABLE `kb_document`
    ADD INDEX `idx_folder_id` (`folder_id`) USING BTREE;